...
local colors = require("qkzk2.colors")
...
function M.setup(config)
  ...
  theme.base = {
    ...
    CursorLineNr = { fg = c.teal }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    ...
    -- Pmenu = { bg = config.transparent and c.none or c.bg, fg = c.fg }, -- Popup menu: normal item.
    -- PmenuSel = { bg = config.transparent and c.none or c.bg }, -- Popup menu: selected item.
    -- PmenuSbar = { bg = config.transparent and c.none or c.bg }, -- Popup menu: scrollbar.
    -- PmenuThumb = { bg = config.transparent and c.none or c.bg }, -- Popup menu: Thumb of the scrollbar.
    ...
    Todo = { bg = config.transparent and c.none or c.bg, fg = c.fg }, -- (preferred) anything that needs extra attention; mostly the keywords TODO FIXME and XXX
    -- TODO: aze
    -- FIXME: aze
    -- BUG: aze
  ...
  theme.plugins = {
    ...
    LspFloatWinNormal = { bg = config.transparent and c.none or c.bg_float },
